...
\NEW{Abil}{\hp}{
  \s\MYname	{Endurance}
  \s\MYtext	{Increase you maximum HP by 2.}
...
\NEW{Abil}{\hpTransfer}{
  ...
  \s\MYtext	{On a 3-count you may give one hit point to an ally at the cost of two hit points to yourself.}
...
\NEW{Abil}{\mem}{
  ...
  \s\MYtext	{You can wait for up to 10 seconds between words of a spell incant before it fizzles.}
  \s\MYeffect	{I have a good memory.}
  }

\NEW{Abil}{\daze}{
  \s\MYname	{Dazing blow}
  \s\MYtext	{One per 30 seconds you can make an attack with a club for daze instead of its normal damage.}
...
\NEW{Abil}{\freedomofmovement}{
  ...
  \s\MYtext	{You are immune to the effects of root.}
